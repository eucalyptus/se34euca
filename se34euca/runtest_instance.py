...
def main():
	...
	parser.add_option("-t", "--testcase", dest="testcase", help="testcase: launch_instance_basic, launch_instance_name_testinstance, terminate_instance_basic, terminate_instance_all, launch_instance_from_images_lp, launch_instance_from_instances_lp")
