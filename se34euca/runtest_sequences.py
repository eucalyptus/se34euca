...
from se34euca.testcase.testcase_sequences import *

def main():

    testcase = "instance_operations"
    ...
    parser.add_option("-t", "--testcase", dest="testcase", help="testcase: instance_operations, keypair_operations")
    ...
    ui = testcase_sequences(testcase)
