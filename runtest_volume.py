...
from se34euca.testcase.testcase_volume import *

def main():

	testcase = "create_volume"
	...
	parser.add_option("-t", "--testcase", dest="testcase", help="testcase: create_volume, delete_volume")
