...
class testcase_view_page(testcase_base):
	...
	print
	self.eucaUITester.test_ui_login()
	self.eucaUITester.test_ui_gotopage_keypairs()
	self.eucaUITester.test_ui_logout()
	...
	print
	self.eucaUITester.test_ui_login()
	self.eucaUITester.test_ui_gotopage_running()
	self.eucaUITester.test_ui_logout()
	...
	print
	self.eucaUITester.test_ui_login()
	self.eucaUITester.test_ui_gotopage_security_groups()
	self.eucaUITester.test_ui_logout()
	...
	print
	self.eucaUITester.test_ui_login()
	self.eucaUITester.test_ui_gotopage_volumes()
	self.eucaUITester.test_ui_logout()
